...
public class MethodeContentCollectionResource {
    ...
    public MethodeContentCollectionResource(MessageProducingContentCollectionMapper msgProducingContentCollectionMapper,
            EomFileToContentCollectionMapper eomContentCollectionMapper, ContentCollectionValidator contentCollectionValidator) {
