...
public class ContentCollectionValidator {
  ...
  public void validate(EomFile eomContentCollection)
      throws ValidationException, UnsupportedTypeException {
  ...
  private void validateUuids(final String mainUuid, final List<EomLinkedObject> linkedObjects)
