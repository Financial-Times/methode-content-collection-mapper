...
public class ContentCollectionValidatorTest {
  ...
  public void thatNullContentTypeThrowsException() {
    final EomFile eomFile = new EomFile.Builder().withUuid(UUID.randomUUID().toString()).build();
    contentCollectionValidator.validate(eomFile);
  }
  ...
  public void thatInvalidContentTypeThrowsException() {
    final EomFile eomFile =
        new EomFile.Builder().withUuid(UUID.randomUUID().toString()).withType("typeABC").build();
    contentCollectionValidator.validate(eomFile);
  }
  ...
  public void thatNoExceptionIsThrownWhenValid() throws Exception {
    final EomFile eomFile =
        new EomFile.Builder()
            ...
            .withLinkedObjects(
                new EomLinkedObject.Builder().withUuid(UUID.randomUUID().toString()).build())
            .build();
    contentCollectionValidator.validate(eomFile);
  }
}
