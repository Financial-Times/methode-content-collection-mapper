...
public class NativeCmsPublicationEventsListenerTest {
  ...
  @Mock private MessageProducingContentCollectionMapper msgProducingContentCollectionMapper;
  ...
  public void thatMessageIsSuccessfullyMapped() throws Exception {
    ...
    msg.setMessageBody(
        objectMapper.writeValueAsString(
            buildContentPackageEomFile(UUID_CONTENT_COLLECTION, EOM_WEB_CONTAINER)));

    listener.onMessage(msg, TX_ID);

    verify(msgProducingContentCollectionMapper)
        .mapPackage(Matchers.any(), eq(TX_ID), Matchers.any());
  }
  ...
  public void thatMessageIsIgnoredIfUnexpectedSystemIDHeaderFound() throws Exception {
    ...
    verify(msgProducingContentCollectionMapper, never())
        .mapPackage(Matchers.any(), anyString(), Matchers.any());
  }
  ...
  public void thatMessageIsIgnoredIfNotSupportedContentTypeDetected() throws Exception {
    ...
    msg.setMessageBody(
        objectMapper.writeValueAsString(
            buildContentPackageEomFile(UUID_CONTENT_COLLECTION, "foobaz")));
