...
public class MessageBuilderTest {
  ...
  private String contentUriPrefix =
      "http://methode-content-collection-mapper.svc.ft.com/content-collection/";
  ...
  public void thatContentCollectionMapperExceptionIsThrownIfMarshallingToStringFails()
  ...
  public void thatContentUriIsCorrectForContentPackage() throws IOException {
    ...
    ContentCollection list =
        new ContentCollection.Builder()
            ...
            .withLastModified(new Date())
            .withPublishReference(PUBLISH_REFERENCE)
            .withType(ContentCollectionType.CONTENT_PACKAGE_TYPE)
            .build();
