...
public class DocumentStoreApiClientTest {
  ...
  private static final String DOC_STORE_CONTENT_ENDPOINT =
      "http://document-store-api:8080/content/";
  ...
  public void testResolveUUIDWhenOk() throws Exception {
    when(mockedJerseyClient.resource(
            URI.create(
                "http://document-store-api:8080/content-query?"
    ...
    when(mockedResponse.getLocation())
        .thenReturn(URI.create("http://api.ft.com/6c6d690a-95e4-449f-9d34-7f211f4e5b1e"));
    DocumentStoreApiClient documentStoreClient =
        new DocumentStoreApiClient(
            mockedJerseyClient, "document-store-api", 8080, "document-store-api");

    String resolvedUuid =
        documentStoreClient.resolveUUID(
            "http://api.ft.com/system/FT-LABS-WP-1-2",
            "http://blogs.ft.com/the-world/?p=1234",
            "tid_1");
  ...
  public void testResolveUUIDThrowWhen404() throws Exception {
    ...
    DocumentStoreApiClient documentStoreClient =
        new DocumentStoreApiClient(mockedJerseyClient, "document-store-api", 8080, "");
